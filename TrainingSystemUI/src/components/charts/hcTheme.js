...
export function applyHcTheme() {
    Highcharts.setOptions({
        ...
        tooltip: {
            ...
            pointFormat: '<div style="display:flex;align-items:center;gap:6px;padding:2px 0"><span style="font-size:12px;color:' + INK_SOFT + '">{series.name}</span><span style="font-weight:700;font-family:Sora,Inter,sans-serif;padding-left:4px">{point.y}</span></div>',
        ...
        plotOptions: {
            bar: {
                ...
                states: {
                    hover: {
                        brightness: 0.08,
                        shadow: { color: "rgba(0,0,0,.15)", offsetX: 0, offsetY: 2, width: 8 },
                    },
                },
            },
            pie: {
