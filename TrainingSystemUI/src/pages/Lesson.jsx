                        ...
                        {filteredLessons.map(lesson => {
                            ...
                            return (
                                <tr key={lesson.lessonID}>
                                    ...
                                    <td>
                                        <span className={`badge ${completed ? "badge-video" : ""}`} style={completed ? { background: "var(--success-bg)", color: "var(--success)" } : { background: "var(--surface-sunken)", color: "var(--ink-soft)" }}>
